...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "evidence.similarity": _s("Similarity", "درجة التشابه"),
    "evidence.no_context": _s(
        "No sufficient information was found in the available regulatory documents to answer this question.",
        "لم أجد في المستندات النظامية المتاحة معلومات كافية للإجابة عن هذا السؤال."),
    ...
    "common.not_found": _s("Not found", "غير موجود"),
    "common.not_applicable": _s("Not applicable", "لا ينطبق"),
    "common.ambiguous": _s("Ambiguous in the contract", "غامض في العقد"),
    ...
    # ------------------------------------------------------------------ analyze: result dashboard
    "analyze.tab_overview": _s("Contract Overview", "نظرة عامة على العقد"),
    "analyze.tab_compliance": _s("Legal Compliance", "الالتزام النظامي"),
    "analyze.tab_compensation": _s("Compensation", "التعويضات"),
    "analyze.tab_salary_benchmark": _s("Salary Benchmark", "مقارنة الراتب"),
    "analyze.tab_findings": _s("Findings", "النتائج"),
    "analyze.tab_cv": _s("CV Compatibility", "توافق السيرة الذاتية"),
    "analyze.contract_info_title": _s("Contract Information", "معلومات العقد"),
    "analyze.legal_compliance_card": _s("Legal Compliance", "الالتزام النظامي"),
    "analyze.compensation_card": _s("Compensation", "التعويضات"),
    "analyze.salary_benchmark_card": _s("Salary Benchmark", "مقارنة الراتب"),
    "analyze.findings_card": _s("Findings & Recommendations", "النتائج والتوصيات"),
    "analyze.key_findings": _s("Key findings", "أبرز النتائج"),
    "analyze.requires_review": _s("Requires review", "يحتاج مراجعة"),
    "analyze.missing_information": _s("Missing information", "معلومات غير متوفرة"),
    "analyze.recommendations": _s("Recommendations and notes", "التوصيات والملاحظات"),
    "analyze.no_compliance_data": _s("No regulatory checks were produced for this contract.",
                                     "لم تُنتج أي مطابقة نظامية لهذا العقد."),
    "analyze.no_compensation_data": _s("No compensation fields were found in this contract.",
                                       "لم تُعثر على بنود تعويضات في هذا العقد."),
    "analyze.no_key_findings": _s("No compliant or non-compliant clause was determined for this contract.",
                                  "لم يتم تحديد أي بند مطابق أو غير مطابق لهذا العقد."),
    "analyze.no_review_items": _s("Nothing is currently flagged for review.", "لا توجد بنود بحاجة إلى مراجعة حالياً."),
    "analyze.no_missing_info": _s("Every checked field was found in the contract.",
                                  "تم العثور على جميع الحقول التي تم فحصها في العقد."),
    ...
    "compare.group_compliance": _s("Legal Compliance", "الامتثال النظامي"),
    "compare.group_compensation": _s("Compensation", "التعويضات"),
    "compare.group_salary": _s("Compensation differences", "الفروق في التعويضات"),
    "compare.group_salary_benchmark": _s("Salary Benchmark", "مقارنة الراتب"),
    "compare.group_benefits": _s("Benefits", "المزايا"),
    "compare.group_working_conditions": _s("Working conditions", "ظروف العمل"),
    "compare.group_contract_terms": _s("Contract terms", "بنود العقد"),
    "compare.group_cv_compatibility": _s("CV compatibility", "توافق السيرة الذاتية"),
    "compare.at_a_glance": _s("At a glance", "نظرة سريعة"),
    "compare.not_available_short": _s("Not available", "غير متاح"),
    "compare.salary_benchmark_informational": _s(
        "Informational market data — not used to determine legal compliance.",
        "بيانات معلوماتية عن السوق — لا تُستخدم لتحديد الامتثال النظامي."),
    "compare.risk_group_high": _s("Needs urgent attention", "يتطلب اهتماماً عاجلاً"),
    "compare.risk_group_medium": _s("Needs review", "يحتاج إلى مراجعة"),
    "compare.risk_group_info": _s("For your information", "للعلم"),
    "compare.not_ranked_note": _s("Shown for information; not used to favour a contract.",
                                  "تُعرض للمعلومة فقط، ولا تُستخدم لتفضيل عقد."),
    "compare.contracts_title": _s("Contracts compared", "العقود المقارَنة"),
    "compare.key_differences": _s("Key differences", "الفروق الرئيسية"),
    "compare.no_differences": _s("No differences in legal compliance between the compared contracts.",
                                 "لا توجد فروق في الالتزام النظامي بين العقود المقارَنة."),
    ...
    "status.ambiguous": _s("Contract wording is unclear", "صياغة العقد غير واضحة"),
    ...
    "ui.source_unavailable": _s("The source text for this figure could not be displayed.",
                                "تعذّر عرض النص المصدر لهذا الرقم."),
