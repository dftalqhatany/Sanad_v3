"""Contract Analysis Agent -> RegulatoryRAGAdapter -> REAL rag/ code and knowledge base.

Only Qdrant, the e5 embedding model and OpenAI are simulated (tests/fakes/infra_stubs.py). The agent's
...
from agents import ContractAnalysisAgent, LLMEvidenceInterpreter
