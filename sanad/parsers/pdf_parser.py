"""PDF parsing with PyMuPDF (the PDF library the regulatory knowledge base was built with).
...
from parsers.normalization import count_text_chars
...
def _load_pymupdf():
    try:
        ...
        try:
            import fitz as pymupdf  # older PyMuPDF (the knowledge base was built with 1.23.8)
