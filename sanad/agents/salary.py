...
from models.analysis import SalaryBenchmark, SalaryQuery
...
def build_salary_provider(salary_settings: SalarySettings | None = None, *, client=None) -> SalaryBenchmarkProvider:
    ...
    from agents.salary_web import WebSearchSalaryProvider  # imported lazily: it needs the web tools
    from tools.web_search import HttpWebSearchClient
